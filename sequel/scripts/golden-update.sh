...
#
# The asset declares the Sequel major it was generated under, and the writer refuses to run
# under any other one — otherwise a toolchain swap arrives looking like a translation change.
# Run it under the default, which resolves the newest release of that major.
set -euo pipefail
