...
Gem::Specification.new do |spec|
  ...
  # One major, because golden/expectations.json records SQL that Sequel's own literalizer wrote
  # and declares the major it was written under. 5.60 is the floor CI tests: it is the oldest
  # release the translator unit test renders byte-identically, so a wider range would be a
