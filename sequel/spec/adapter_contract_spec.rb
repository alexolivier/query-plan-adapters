...
# them and the reason this file is worth its length — a many_to_many through a join table, an
# association with conditions, a block or a custom dataset, a model over a filtered dataset,
# single-table inheritance and a composite key are Sequel MODEL shapes, and no policy can
# describe one.
#
