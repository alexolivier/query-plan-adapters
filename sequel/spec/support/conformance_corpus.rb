...
module ConformanceCorpus
  ...
  # Read as UTF-8 explicitly. The corpus carries non-ASCII strings, and Ruby otherwise decodes a
  # file in the locale's encoding — which on a runner with no LANG set is US-ASCII.
